...
export const SceneAnnotations = ({ annotations }: { annotations: AnnotationDto[] }) => {
  return (
    <>
...
const HoverableSphere = ({ annotation }: { annotation: AnnotationDto }) => {
  ...
  return (
    <group position={[annotation.coordinates.x, annotation.coordinates.y, annotation.coordinates.z]}>
      <Sphere
