...
export const ViewerLayout = () => {
    ...
    const [pendingPoint, setPendingPoint] = useState<THREE.Vector3 | undefined>(undefined);
    ...
    const handleAnnotationSubmit = useCallback((label: string, description: string) => {
        ...
        <div className="grid grid-rows-[1fr_auto] h-screen divide-y divide-gray-500">
            <div className="grid grid-cols-1 md:grid-cols-[3fr_1fr] divide-x divide-gray-500 overflow-hidden">
                ...
                <AnnotationModal
                                ...
                                />
                <Scene>
                    <SceneContext selectedModelLocation={selectedModel?.location} setPendingPoint={setPendingPoint} setPointModalOpen={setAnnotationModalOpen} />
