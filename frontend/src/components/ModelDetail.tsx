        ...
        <div className="bg-gray-800 text-white p-6 overflow-y-auto">
            ...
            {hasData ? (
                <ul className="space-y-2">
                    ...
                    <li><span className="font-semibold">Study Date:</span> {format(modelMetadata.studyDate, "MMMM do, yyyy H:mma")}</li>
                    <li><span className="font-semibold">Modality:</span> {modelMetadata.modality}</li>
                    <li><span className="font-semibold">Description:</span> {modelMetadata.studyDescription}</li>
                </ul>
            ) : (
